                ...
                <div className="row"> 
                   {[
                        ...
                        },
                        {
                           ...
                           description :'A weather dashboard that uses the Openweather API to retrieve current and future conditions for any city.',
                           imgSrc: WeatherDashboard,
                           deployedLink: 
                             'https://msadio8.github.io/Weather-Dashboard/',
                            githubLink: 
                             'https://github.com/msadio8/Weather-Dashboard',
                        },
                       {
                            title:'Tech Blog ',
                        ...
                        {
                           title:'Note Taker ',
                           description: 'This application will use an Express.js back end and will save and retrieve note data from a JSON file and will be deployed in Heroku .',
                           imgSrc: NoteTaker,
                           deployedLink: 
                            'https://note-taker-challenge11-db387f76c791.herokuapp. com/',
                           githubLink: 
                            'https://github.com/msadio8/Note-Taker',

                        },
                       {
                           title: 'Work Day Scheduller',
